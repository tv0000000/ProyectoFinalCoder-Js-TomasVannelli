...
const navBar = () => {
  const vemosNav = document.createElement("div");
  vemosNav.classList.add("container-fluid");
  vemosNav.innerHTML =
    `<a href="index.html"><img class="logoResto" src="img/logo2.png"></a>
        <button class="navbar-toggler" type="button"></button>
        <ul class="navbar-nav">
            <li class="nav-item">
            <button class="buttonNav" id = "botonModo">Modo claro/oscuro</button>
            </li>
        </ul>`
...
// ******* INVOCAMOS FUNCION PARA MOSTRAR NAV *******
navBar()
...
const mostrarmosHamburgesas = document.getElementById("mostrarHamburguesas");
...
function mostrarProductos(productos) {
  productos.forEach(producto => {
    ...
    mostrarmosHamburgesas.appendChild(cardBs);
